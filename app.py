...
with st.sidebar:
    ...
    st.divider()
    proposal_type = st.radio("제안서 유형", ["티저형 (2~3페이지)", "제안형 (8~10페이지)"],
        help="티저형: 미팅 전 첫 컨택용 / 제안형: 미팅 후 계약·기술료 협의용")
...
with col2:
    ...
    if ir_file:
        ...
        st.markdown('<div class="info-box">기업자료가 없으면 OpenAI가 공개 정보를 기반으로 추론합니다. 확인되지 않은 내용에는 "(추정)" 표기가 적용됩니다.</div>', unsafe_allow_html=True)
